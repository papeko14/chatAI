...
Data = st.Page(page=r'C:\Users\papeko14\Documents\fastwork\สอนไพธอน\mentor\2025-07-29\views\testdata.py',title='Datatest', icon='📅')
...
test_data = st.Page(page=r'C:\Users\papeko14\Documents\fastwork\สอนไพธอน\mentor\2025-07-29\views\Table_Data.py',title='show_db')
pg = st.navigation(
