...
if st.session_state.get("current_machine") != selected_zone:
    st.session_state.messages = load_chat_history(selected_zone)
    st.session_state["current_machine"] = selected_zone
...
if prompt := st.chat_input("Say something..."):
    ...
    try:
        ...
        payload = {"message": prompt, "machine": selected_zone} # เพิ่ม machine name ใน payload
    ...
    save_chat_history(selected_zone, st.session_state.messages)
    st.rerun()
